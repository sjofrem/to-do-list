...
class UI{
    ...
    static initProjectBtns(){
        ...
        addProjectForm.addEventListener('submit', (e) =>{
            ...
            _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.addProject(newProject);
        ...
        newTaskForm.addEventListener('submit', (e) =>{
            ...
            const newTask = new _task__WEBPACK_IMPORTED_MODULE_2__.Task(title, dueDate, priorirty, projectTitle);
            _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.addTask(projectTitle,newTask);
            this.clearTasks();

            const tasks = _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.getToDoList().getProject(projectTitle).getTasks();
    ...
    static createCustomProjectBtn(title){
        ...
        close.addEventListener('click', () => {
            ...
            _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.deleteProject(title);
            this.renderCustomProjectBtns();
    ...
    static renderProjectContent(title){
        ...
        this.initNewTaskBtn();
        this.clearTasks();
        const tasks = _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.getToDoList().getProject(title).getTasks();
        this.renderTasks(tasks, 'customTasks');
    }

    static renderAllTasks(){
        const projects = _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.getToDoList().projects;
        let allTasksList = [];
        this.clearTasks();
    ...
    static renderTasks(tasks, type){
        ...
        for(const index in tasks){
            ...
            checkbox.addEventListener('click', () => {
                _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.changeStatus(task.projectTitle, task.title);
            ...
            deleteBtn.addEventListener('click', () => {
                _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.deleteTask(task.projectTitle, task.title);
                this.clearTasks()
                if(type == 'allTasks'){
                    this.renderAllTasks();
                }
                    ...
                    const tasks = _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.getToDoList().getProject(task.projectTitle).getTasks();
    ...
    static updateTask(event){
        ...
        _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.changeTaskPriority(event.currentTarget.projectTitle, event.currentTarget.task.title, priority);
        _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.changeTaskDueDate(event.currentTarget.projectTitle, event.currentTarget.task.title, newDueDate.value);
        _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.changeTaskTitle(event.currentTarget.projectTitle, event.currentTarget.task.title, newTaskTitle.value);
        ...
        if(event.currentTarget.type == 'allTasks'){
            ...
            const tasks = _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.getToDoList().getProject(event.currentTarget.projectTitle).getTasks();
    ...
    static renderCustomProjectBtns(){
        ...
        const projects = _storage__WEBPACK_IMPORTED_MODULE_1__.Storage.getToDoList().getProjects();
...
class Task{
    ...
    getDateUI(){
        ...
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(date, 'PPP');
    }
